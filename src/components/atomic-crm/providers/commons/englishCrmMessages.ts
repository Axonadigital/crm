export const englishCrmMessages = {
  resources: {
    ...
    calendar_events: {
      ...
      embed: {
        ...
        description:
          "Embedded Google Calendar for fast testing before deeper CRM sync.",
      },
      list: {
        description: "Manage meetings, links, and attendees in one place.",
    ...
    quotes: {
      ...
      fields: {
        ...
        terms_and_conditions_placeholder: "Enter terms and conditions...",
        notes_internal: "Internal notes",
        notes_internal_placeholder: "Internal notes (not shown on quote)...",
        no_content: "No content yet. Click Edit to add.",
        generated_text: "Quote text",
      ...
      templates: {
        default: "Standard",
        webb: "Webb",
        webb_med_support: "Webb med support",
        seo: "SEO",
        ai_konsult: "AI-konsult",
        drift: "Drift & Underhåll",
      },
      action: {
        create: "Create Quote",
        new: "New Quote",
        ...
        view_signed: "View signed document",
      },
      statuses: {
        draft: "Draft",
      ...
      empty: {
        ...
        description: "It seems your quote list is empty.",
      },
      line_items: {
        title: "Line items",
        description: "Description",
      ...
      notifications: {
        ...
        text_generated: "Quote text generated successfully",
        text_generation_failed: "Failed to generate quote text",
        pdf_generated: "PDF generated successfully",
        pdf_generation_failed: "Failed to generate PDF",
        sent_for_signing: "Quote sent for signing",
        sending_failed: "Failed to send quote for signing",
        signed: "Quote has been signed!",
  ...
  crm: {
    auth: {
      ...
      welcome_title: "Welcome to Axona Digital CRM",
    },
    common: {
      activity: "Activity",
      added: "added",
    ...
    dashboard: {
      ...
      stepper: {
        install: "Set up Axona Digital CRM",
    ...
    settings: {
      ...
      seller_company: {
        ...
        f_skatt: "Registered for F-skatt",
        ...
        iban: "IBAN",
        bic: "BIC/SWIFT",
        defaults_heading: "Default Quote Terms",
        payment_terms: "Payment Terms",
        delivery_terms: "Delivery Terms",
        terms_and_conditions: "Terms & Conditions",
        quote_logo_heading: "Quote Logo",
        quote_logo_description:
          "Logo shown on quotes (recommended: light background)",
      },
      validation: {
    ...
    profile: {
      inbound: {
        description:
          "You can start sending emails to your server's inbound email address, e.g. by adding it to the %{field} field. Axona Digital CRM will process the emails and add notes to the corresponding contacts.",
        title: "Inbound email",
      },
      password: {
